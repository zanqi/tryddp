...
def generate(prompt: torch.Tensor):
    ...
    with torch.no_grad(), torch.amp.autocast(
        ...
        for _ in range(num_samples):
            y = model.generate(
                prompt, max_new_tokens, temperature=temperature, top_k=cfg.top_k
            )
...
@hydra.main(version_base=None, config_path=".", config_name="gpt2_generate_cfg")
